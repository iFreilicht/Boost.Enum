...
//actual implementation
#define BOOST_ADVANCED_ENUM__IDECLARE_ENUM_VALUE(...)								\
	static const EnumT BOOST_PP_VARIADIC_ELEM(0, __VA_ARGS__) =							\
		EnumT::BOOST_PP_VARIADIC_ELEM(0, __VA_ARGS__);								\

//sequence unpacking
#define BOOST_ADVANCED_ENUM__IDECLARE_ENUM_VALUE_A(enum_name, ...)								\
	BOOST_ADVANCED_ENUM__IDECLARE_ENUM_VALUE(__VA_ARGS__)							\
		BOOST_ADVANCED_ENUM__IDECLARE_ENUM_VALUE_B									\

#define BOOST_ADVANCED_ENUM__IDECLARE_ENUM_VALUE_B(...)								\
	BOOST_ADVANCED_ENUM__IDECLARE_ENUM_VALUE(__VA_ARGS__)							\
		BOOST_ADVANCED_ENUM__IDECLARE_ENUM_VALUE_A									\

#define BOOST_ADVANCED_ENUM__IDECLARE_ENUM_VALUE_A_
#define BOOST_ADVANCED_ENUM__IDECLARE_ENUM_VALUE_B_

//macro to call
#define BOOST_ADVANCED_ENUM__DECLARE_ENUM_VALUE(enum_name, seq)								\
	BOOST_ADVANCED_ENUM_CAT(BOOST_ADVANCED_ENUM__IDECLARE_ENUM_VALUE_A seq, _)					\
